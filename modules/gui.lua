  ...
  do -- Generate Config UI
    ...
    for id, data in ipairs(unitframeSettings) do
      ...
      CreateGUIEntry(T["Unit Frames"], t, function()
        ...
        CreateConfig(U[c], T["Indicator Alpha"], C.unitframes[c], "heal_ind_alpha")
        CreateConfig(U[c], T["Show 20yd indicator"], C.unitframes[c], "heal_ind_20yd", "checkbox")
        ...
        CreateConfig(U[c], T["LOS Indicators (requires rage fading+UnitXp)"], nil, nil, "header")
